$(document).ready(function () {
  $("#showing-now-movie-carousel").load(
    "../components/movie-carousel.html",
    function (e) {
      $.getScript("../assets/js/owl.carousel.min.js", function () {
        var movieCarousel = $("#showing-now-movie-carousel");

        //update tab title
        movieCarousel.find("#tab-title").text("showing now");
        ...
        var apiURL = "http://localhost:8080/movie/now_playing";
